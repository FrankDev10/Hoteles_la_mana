...
import 'package:hoteladmin/src/pages/register/register_controller.dart';
import 'package:hoteladmin/src/pages/register/validacion.dart';
  ...
  Widget _buttonLogin(FormularioFromProvider re) {
    return Container(
      ...
      child: ElevatedButton(
        onPressed: () {
          final validFrom = re.validateFrom(context);
          if (!validFrom) return;
          _con.register();
        },
